...
namespace Vista
{
    public partial class GeneraLibroVenta : Form
    {
        DataTable dataTable = new DataTable();
        LibroVentaModel libroCompraM = new LibroVentaModel();
        EmpresaModel empresaM = new EmpresaModel();
        public GeneraLibroVenta()
        {
            InitializeComponent();
        }

        private void GeneraLibroVenta_Load(object sender, EventArgs e)
        {
            actualizaDG();
        }
        ...
        public void actualizaDG()
        {
            ...
            dataTable = libroCompraM.listaLibroXFecha(new DateTime());
